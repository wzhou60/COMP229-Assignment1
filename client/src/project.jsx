  ...
  return (
    <>
      ...
      <div className="project">
        ...
        <p>
          Created a restaurant website using HTML, CSS, and JavaScript. The website features a menu,
          ordering system, and contact form. Ensured the website is mobile-friendly and easy to
          navigate.
        </p>
